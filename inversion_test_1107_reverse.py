...
# reverse
# runs/1104_lr1e4_n32_b1024_ddim_50_150_steps_no_init_rkdW0.01_invW0.1_invinv_W1.0_fid_W0.0001_reverse180/ckpt_student_step135000.pt

def main():
    parser = argparse.ArgumentParser(description="Batch DDIM Inversion → Resampling for .npy data")
    parser.add_argument("--npy", type=str, default="smile_data_n32_scale2_rot180_trans_50_-20/train.npy", help="Path to x0 .npy file (shape [N, D])")
    parser.add_argument("--teacher_ckpt", type=str, default="runs/1104_lr1e4_n32_b1024_ddim_50_150_steps_no_init_rkdW0.01_invW0.1_invinv_W1.0_fid_W0.0001_reverse180/ckpt_student_step135000.pt", help="Path to teacher checkpoint")
    parser.add_argument("--out_dir", type=str, default="inversion_test", help="Output directory")
    ...
    parser.add_argument("--norm_json", type=str, default="smile_data_n32_scale2_rot180_trans_50_-20/normalization_stats.json", help="JSON with {'mean': [...], 'std': [...]}")
    ...
    mu_teacher, sigma_teacher = load_norm_stats("smile_data_n8192_scale10_rot0_trans_0_0/teacher_normalization_stats.json")
