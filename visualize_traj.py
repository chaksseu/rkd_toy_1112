...
# runs/1119_lr1e4_n32_b256_ddim_50_150_steps_no_init_rkdW1.0_x0_pred_rkd_with_teacher_x0/ckpt_student_step050000.pt
# runs/1119_lr1e4_n32_b256_ddim_50_150_steps_no_init_rkdW1.0_xt/ckpt_student_step050000.pt

# ===================== ARGS / ENTRY ===================== #
def parse_args():
    parser = argparse.ArgumentParser(description="Visualize Student DDIM trajectories + pure score field (norm & denorm).")
    parser.add_argument("--ckpt", type=str,
        default="runs/1119_lr1e4_n32_b256_ddim_50_150_steps_no_init_rkdW1.0_x0_pred_rkd_with_teacher_x0/ckpt_student_step050000.pt",
    ...
    parser.add_argument("--out", type=str, default="vis_traj_rkd_all_x0_pred_with_teacher_x0", help="Output directory root.")
