...
def parse_args():
    ...
    parser.add_argument("--ckpt", type=str,
        default="runs/1201_lr1e4_n32_b1024_ddim_50_150_steps_no_init_rkdW0.08_invW0.1_invinvW1.0_fidW0.0005_sameW0.0001_x0_pred_rkd_with_teacher_x0_inv_only_x0/ckpt_student_step065000.pt",
    ...
    parser.add_argument("--out", type=str, default="vis_traj_1201_rkd0.08_inv0.1_invinv1.0_fd0.0005_same1e-4", help="Output directory root.")
