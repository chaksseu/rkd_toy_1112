...
CONFIG = {
    ...
    # wandb
    "use_wandb": True,
    "wandb_project": "RKD-DKDM-AICA-1112",
...
def train_student_uniform_xt(cfg: Dict):
    ...
    for step_i in range(1, total_steps + 1):
        ...
        for i in range(len(xt_S_seq)-1):
            ...
            xt_S_i = denormalize_torch(xt_S_seq[i], mu_student_tensor, sigma_student_tensor)
            xt_S_i_1 = denormalize_torch(xt_S_seq[i+1], mu_student_tensor, sigma_student_tensor)
