...
def main():
    ...
    parser.add_argument("--teacher_ckpt", type=str, default="runs/1102_lr1e4_n32_b1024_ddim_50_150_steps_no_init_rkdW0.1_invW1.0_invinv_W1.0_fid_W0.0001_reverse180/ckpt_student_step025000.pt", help="Path to teacher checkpoint")
