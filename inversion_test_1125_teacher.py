...
def main():
    ...
    parser.add_argument("--teacher_ckpt", type=str, default=f"runs/1202_only_diff_loss_B1024_teacher65536_T{TT}/ckpt_student_step320000.pt", help="Path to teacher checkpoint")
    parser.add_argument("--out_dir", type=str, default=f"inversion_test_1202_teacher_T{TT}", help="Output directory")
    ...
    parser.add_argument("--batch_size", type=int, default=8192, help="Batch size for inversion/sampling")
