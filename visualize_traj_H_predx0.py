...
def collect_student_xt_seq_ddim(student: nn.Module,
    ...
    try:
        for t in sched.timesteps:
            ...
            xs.append(pred_x0.detach().cpu().numpy())
    finally:
        if was_train:
            student.train()
...
def parse_args():
    ...
    parser.add_argument("--ckpt", type=str,
        default="ckpt_teacher_T1000_step370000_1021.pt",
    ...
    parser.add_argument("--out", type=str,
                        default="vis_traj_rkd_teacher_pred_x0",
                        help="Output directory root.")
    parser.add_argument("--seed", type=int, default=42, help="Random seed.")
    parser.add_argument("--student-stats", type=str,
                        default="smile_data_n8192_scale10_rot0_trans_0_0/teacher_normalization_stats.json",
    ...
    # H-module ckpt
    parser.add_argument("--H-ckpt", type=str, default=None,
