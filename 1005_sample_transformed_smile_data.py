...
def main():
    ...
    ap.add_argument("--src_dir", type=str, default="recovered_from_affine_H",
                    help="input folder containing train.npy (and optional val.npy, *_labels.npy)")
    ap.add_argument("--out_dir", type=str, default=f"smile_data_n8192_scale10_rot0_trans_0_0_affine_H_-10_2_-180_-3_3_260_n{NUM}",
